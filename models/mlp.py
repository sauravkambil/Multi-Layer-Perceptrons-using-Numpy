...
class MLP0:
    ...
    def forward(self, A0):
        ...
        A1 = np.array(self.f[0].forward(Z0), dtype='f')
...
class MLP1:
    ...
    def forward(self, A0):
        ...
        A1 = np.array(self.f[0].forward(Z0),dtype='f')  # TODO

        Z1 = self.layers[1].forward(A1)  # TODO
        A2 = np.array(self.f[1].forward(Z1), dtype='f') # TODO

        a = A0
        l = len(self.layers)
        #for i in range(l):

            #Z0 = self.layers[i].forward(a)  # TODO
              # TODO
